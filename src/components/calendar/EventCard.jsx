  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "flex h-full w-full cursor-pointer flex-col overflow-hidden rounded-lg border border-l-4 bg-card px-2 py-1 text-left shadow-sm transition-shadow group-hover:shadow-md",
