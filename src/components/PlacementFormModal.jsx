      ...
      <div className="modal-box max-w-lg" role="dialog" aria-modal="true">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <Field label={t("positionLabel")} required>
            <input className={inputClass + (errors.indexOf("positionTitle") !== -1 ? " border-accent" : "")} value={fields.positionTitle} onChange={(e) => setField("positionTitle", e.target.value)} />
          </Field>
          ...
          <Field label={t("hourlyWageLabel")}><input type="number" step="0.01" className={inputClass} value={fields.hourlyWage} onChange={(e) => setField("hourlyWage", e.target.value)} /></Field>
          ...
          <Field label={t("supervisorNameLabel")}><input className={inputClass} value={fields.supervisorName} onChange={(e) => setField("supervisorName", e.target.value)} /></Field>
          <Field label={t("supervisorContactLabel")}><input className={inputClass} value={fields.supervisorContact} onChange={(e) => setField("supervisorContact", e.target.value)} /></Field>
        </div>
        <div className="mt-3">
