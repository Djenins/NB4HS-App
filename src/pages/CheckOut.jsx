...
export default function CheckOut() {
  ...
  return (
    <>
      ...
      {list.length ? (
        <div className="mb-5 rounded-2xl border border-success/30 bg-success/5 p-5">
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-primary/20 bg-primary-tint px-5 py-4">
